(function (e, t) {
  ...
  b.extend({
    queue: function (e, n, r) {
      var i;
      return e ? (n = (n || 'fx') + 'queue', i = b._data(e, n), r && (!i || b.isArray(r) ? i = b._data(e, n, b.makeArray(r))  : i.push(r)), i || [
      ])  : t
    },
  ...
  b.fn.extend({
    ...
    addClass: function (e) {
      ...
      ]; s > a; a++) if (n = this[a], r = 1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(X, ' ')  : ' ')) {
        o = 0;
  ...
  function (e, t) {
    ...
    function st(e, t, n, r) {
      ...
      m,
      v;
      if ((t ? t.ownerDocument || t : w) !== p && c(t), t = t || p, n = n || [
  ...
  b.extend({
    ...
    ajax: function (e, n) {
      ...
      if (h.promise(N).complete = g.add, N.success = N.done, N.error = N.fail, p.url = ((e || p.url || yn) + '').replace(xn, '').replace(kn, mn[1] + '//'), p.type = n.method || n.type || p.method || p.type, p.dataTypes = b.trim(p.dataType || '*').toLowerCase().match(w) || [
        ''
      ], null == p.crossDomain && (r = En.exec(p.url.toLowerCase()), p.crossDomain = !(!r || r[1] === mn[1] && r[2] === mn[2] && (r[3] || ('http:' === r[1] ? 80 : 443)) == (mn[3] || ('http:' === mn[1] ? 80 : 443)))), p.data && p.processData && 'string' != typeof p.data && (p.data = b.param(p.data, p.traditional)), qn(An, p, n, N), 2 === x) return N;
      u = p.global,
